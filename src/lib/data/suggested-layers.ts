import type { LayerPair } from "$lib/types";

export const suggestedLayers: Record<string, [number, number]> = {
...
export const suggestedLayersArray: LayerPair[] = Object.entries(
  suggestedLayers,
).map(([name, [layer1, layer2]]) => ({
  name,
  layer1,
  layer2,
} satisfies LayerPair));
